...
- (id)initJavaMathBigDecimalWithLong:(long long)arg1;
...
- (id)initJavaMathBigDecimalWithJavaMathBigInteger:(id)arg1 withInt:(int)arg2;
- (id)initWithJavaMathBigInteger:(id)arg1 withJavaMathMathContext:(id)arg2;
- (id)initWithJavaMathBigInteger:(id)arg1;
- (id)initJavaMathBigDecimalWithJavaMathBigInteger:(id)arg1;
- (id)initWithDouble:(double)arg1 withJavaMathMathContext:(id)arg2;
- (id)initWithDouble:(double)arg1;
- (id)initJavaMathBigDecimalWithDouble:(double)arg1;
...
- (id)initJavaMathBigDecimalWithCharArray:(id)arg1 withInt:(int)arg2 withInt:(int)arg3;
- (id)initWithInt:(int)arg1 withInt:(int)arg2;
- (id)initJavaMathBigDecimalWithInt:(int)arg1 withInt:(int)arg2;
- (id)initWithLong:(long long)arg1 withInt:(int)arg2;
- (id)initJavaMathBigDecimalWithLong:(long long)arg1 withInt:(int)arg2;
