...
+ (id)getCurrentUIVC;
+ (id)getCurrentWindowVC;
+ (void)hideHUD;
+ (void)showCustomIcon:(id)arg1 message:(id)arg2 isWindow:(_Bool)arg3;
+ (void)showCustomIconInView:(id)arg1 message:(id)arg2;
+ (void)showCustomIconInWindow:(id)arg1 message:(id)arg2;
+ (void)showWarnMessage:(id)arg1;
+ (void)showInfoMessage:(id)arg1;
+ (void)showErrorMessage:(id)arg1;
+ (void)showSuccessMessage:(id)arg1;
+ (void)showActivityMessage:(id)arg1 isWindow:(_Bool)arg2 timer:(int)arg3;
+ (void)showActivityMessageInView:(id)arg1 timer:(int)arg2;
+ (void)showActivityMessageInWindow:(id)arg1 timer:(int)arg2;
+ (void)showActivityMessageInView:(id)arg1;
+ (void)showActivityMessageInWindow:(id)arg1;
+ (void)showTipMessage:(id)arg1 isWindow:(_Bool)arg2 timer:(int)arg3;
+ (void)showTipMessageInView:(id)arg1 timer:(int)arg2;
+ (void)showTipMessageInWindow:(id)arg1 timer:(int)arg2;
+ (void)showTipMessageInView:(id)arg1;
+ (void)showTipMessageInWindow:(id)arg1;
+ (id)createMBProgressHUDviewWithMessage:(id)arg1 isWindiw:(_Bool)arg2;
