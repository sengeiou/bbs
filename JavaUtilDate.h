...
+ (id)__annotations_JavaUtilDateWithNSString_;
+ (id)__annotations_JavaUtilDateWithInt_withInt_withInt_withInt_withInt_withInt_;
+ (id)__annotations_JavaUtilDateWithInt_withInt_withInt_withInt_withInt_;
+ (id)__annotations_JavaUtilDateWithInt_withInt_withInt_;
+ (void)initialize;
...
- (id)initJavaUtilDateWithLong:(long long)arg1;
